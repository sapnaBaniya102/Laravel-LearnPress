												...
												<div class="wizard-step" data-wizard-type="step" data-wizard-state="current">
													<div class="wizard-wrapper">
														...
														<div class="wizard-label">
															<div class="wizard-title">Add coursecat</div><a href="{{ url('coursecat') }}"><button class="p-2 rounded btn-primary">Back </button></a>
											...
											<div class="p-0 card-body">
												<div class="px-8 py-8 row justify-content-center py-lg-15 px-lg-10">
													<div class="col-xl-12 col-xxl-10">
														<!--begin::Wizard Form-->
														<form class="form" id="kt_form" action="{{ route('coursecat.store') }}" method="POST" enctype="multipart/form-data">
                                                            @csrf
